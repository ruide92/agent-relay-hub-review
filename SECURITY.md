...
### 8.1 Capability Token 签名容器（提案 #0007，PROPOSED）

> 本小节为 **Phase 0 治理提案 #0007** 的新增内容，状态 **PROPOSED**，未经独立审核与 owner 批准。
...
- 详细 wire format、claims、校验顺序见 `DECISIONS/ADR-0003-…`（PROPOSED）。

### 8.2 Detached Signature Manifest 规范化签名预映像（提案 #0007，PROPOSED）
